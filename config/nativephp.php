...
return [
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Inventory Management System Dev By Techlink360'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://techlink360.net'),
    ...
    'updater' => [
        ...
        'providers' => [
            'github' => [
                'driver' => 'github',
                'repo' => env('GITHUB_REPO','ims'),
                'owner' => env('GITHUB_OWNER'),
                'token' => env('GITHUB_TOKEN'),
                'vPrefixedTagName' => env('GITHUB_V_PREFIXED_TAG_NAME', true),
                'private' => env('GITHUB_PRIVATE', false),
                'channel' => env('GITHUB_CHANNEL', 'beta'),
